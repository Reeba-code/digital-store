...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $confirmPassword = sanitizeInput($_POST["confirm_psw"]);
...
<html lang="en">
  ...
  <style>
    * {
    ...
    max-width: 700px;
    min-width: 300px;
    margin: 20px auto; /* Adjust the margin to prevent too much space between form and footer */
    padding: 20px;
...
@media (max-width: 480px) {
    .contain {
        width: 95%; /* Further increase the width on extra small screens */
        ...
        <div class="login-form">
            ...
            <?php else: ?>
                <form action="signup.php" method="POST">
                    ...
                    <h3><i>Create your account by filling the information below.</i></h3>
...
<br>
                    ...
                    <div class="buttons">
                        <button type="index.php" class="cancelbtn">Cancel</button>
     ...
     <footer class="footer">
      <div class="row">
        <div class="col d-flex">
          ...
          <a href="./dilevery.html">Delivery Guide</a>
        </div>
        <div class="col d-flex">
          <h4>USEFUL LINK</h4>
